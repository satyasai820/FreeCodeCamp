...
const ButtonComponent = () => {
    ...
    return(
        ...
        }}><Typography sx={{ fontFamily:'"Lato",sans-serif', fontSize: { xs:'20px', sm:'20px', md:'20px',lg:'20px', xl:'18px'}, '& .nav-link': { textDecoration: 'none', color: 'inherit',  },}}>Get started (it's free)</Typography>
           </Button>
    </Box>
    </>
    );

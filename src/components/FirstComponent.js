    ...
    return(
        <Grid container paddingTop={10} justifyContent='center'>
            <Grid  sx={{ width:{sm:'75%',md:'70%',lg:'60%',xl:'50%'}, textAlign:'center',}}>
                <Typography fontFamily='"Hack-ZeroSlash",monospace' sx={{fontSize:{xs:'30px',sm:'45px',md:'50px',lg:'45px',xl:'35px'}, fontWeight:600}}>Responsive Web Design</Typography>
                ...
                <Grid sx={{width:{xs:'95%',sm:'95%',lg:'70%',xl:'75%'}}}>
                    <Typography  sx={{textAlign:"start",color:'#1B1B32',fontSize:{xs:'17px', sm:'18px',xl:'16px'},marginBottom:'20px',fontFamily: '"Lato", sans-serif', }}>In this Responsive Web Design Certification, you'll learn the languages that developers use to build webpages: HTML (Hypertext Markup Language) for content, and CSS (Cascading Style Sheets) for design.</Typography>
                    <Typography  sx={{textAlign:"start",color:'#1B1B32',fontSize:{xs:'17px', sm:'18px',xl:'16px'},marginBottom:'20px',fontFamily: '"Lato", sans-serif', }}>First, you'll build a cat photo app to learn the basics of HTML and CSS. Later, you'll learn modern techniques like CSS variables by building a penguin, and best practices for accessibility by building a quiz site.</Typography>
                    <Typography  sx={{textAlign:"start",color:'#1B1B32',fontSize:{xs:'17px', sm:'18px',xl:'16px'},marginBottom:'20px',fontFamily: '"Lato", sans-serif', }}>Finally, you'll learn how to make webpages that respond to different screen sizes by building a photo gallery with Flexbox, and a magazine article layout with CSS Grid.</Typography>
